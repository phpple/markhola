...
impl InnerWebView {
  ...
  fn create_environment(
    ...
    unsafe {
      ...
      let lang_len = LCIDToLocaleName(lcid as u32, Some(&mut lang), LOCALE_ALLOW_NEUTRAL_NAMES);
      if lang_len > 1 {
        options.set_language(String::from_utf16_lossy(&lang[..lang_len as usize - 1]));
      }

      if matches!(pl_attrs.scroll_bar_style, ScrollBarStyle::FluentOverlay) {
